...
public class RoFactoriesTest implements IRoMessageFactory, ServerRoSessionListener, ClientRoSessionListener {
	...
	public void testGettersAndSettersCCR() throws Exception {
		...
		int nFailures = RoAvpAssistant.INSTANCE.testMethods(ccr, RoCreditControlRequest.class);
	...
	public void doCreditControlAnswer(ClientRoSession session, org.jdiameter.api.ro.events.RoCreditControlRequest request, org.jdiameter.api.ro.events.RoCreditControlAnswer answer)
