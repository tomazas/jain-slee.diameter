...
public class EventIDCache {
  ...
  private static final String RO_PACKAGE_PREFIX = "net.java.slee.resource.diameter.ro.events.";
  ...
  static {
    ...
    eventsTemp.put(CreditControlMessage.commandCode, RO_PACKAGE_PREFIX + "RoCreditControl");
